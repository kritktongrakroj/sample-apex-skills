...
assessment, not a clean bill of health. This generalizes the `workload-risks.md`
...
# TYPES or assign points to satisfy the loop. If a future steering file defines a detectable
...
for each behavioral_change_TYPE explicitly defined-and-detected by a steering file:
...
# As of 2026-08-05 no steering file defines such a TYPE, so this evaluates to 0.
