...
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/skills/eks-operation-review/references/workload-configuration.md
format: md
---

:::info[Source]
This page is generated from [skills/eks-operation-review/references/workload-configuration.md](https://github.com/aws-samples/sample-apex-skills/blob/main/skills/eks-operation-review/references/workload-configuration.md). Edit the source, not this page.
:::
