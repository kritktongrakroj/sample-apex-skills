---
title: "NGINX Ingress to AWS Load Balancer Controller Migration"
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-ingress-migration/assets/atx/td_ingress-nginx-lbc/transformation_definition.md
format: md
---

:::info[Source]
This page is generated from [devops-agent/eks-ingress-migration/assets/atx/td_ingress-nginx-lbc/transformation_definition.md](https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-ingress-migration/assets/atx/td_ingress-nginx-lbc/transformation_definition.md). Edit the source, not this page.
:::
