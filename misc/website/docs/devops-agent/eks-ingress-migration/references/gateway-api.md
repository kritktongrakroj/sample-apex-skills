...
> **Version currency — single source of truth for this skill.** Checked **2026-09-13**: latest AWS Load Balancer Controller release = **v3.5.0** (2026-08-03); latest upstream Gateway API release = **v1.6.2** (2026-09-03). *(v1.6.1 was 2026-07-16; the CRD pairing this skill pins is unchanged — it keys on the v1.6.0 minor.)* Every other file in this skill refers to "the v3.5.0 line" without re-asserting currency — **re-check here, not there**, and update this one note when it moves.
