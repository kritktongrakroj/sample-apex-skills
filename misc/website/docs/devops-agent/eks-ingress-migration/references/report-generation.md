...
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-ingress-migration/references/report-generation.md
format: md
---

:::info[Source]
This page is generated from [devops-agent/eks-ingress-migration/references/report-generation.md](https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-ingress-migration/references/report-generation.md). Edit the source, not this page.
:::
...
> - gate `> 0` → `⛔ <n> blocker(s) need(s) redesign / approval`
>
> Keep the literal `blocker(s) need(s)` plural form — it is neutral for any `n` and it is the wording every other surface of this skill quotes.
