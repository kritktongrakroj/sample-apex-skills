...
description: ""
custom_edit_url: https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-upgrade-check/references/deprecated-apis.md
format: md
---

:::info[Source]
This page is generated from [devops-agent/eks-upgrade-check/references/deprecated-apis.md](https://github.com/aws-samples/sample-apex-skills/blob/main/devops-agent/eks-upgrade-check/references/deprecated-apis.md). Edit the source, not this page.
:::
